...

{
...

    {
        ...
        cout << "\n\nYour current balance is $ " << amount << "n";
...

{
    ...
    cout << "\t1. Choose any number between 1 to 10n";

    cout << "\t2. If you win you will get 10 times of money you betn";
